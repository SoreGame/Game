...
namespace Game
{
    public class Physics
    {
        ...
        public Player MoveRocket(Player player, PlayerForce forceX, PlayerForce forceY, Turn turn, Size spaceSize, double dt)
        {
            ...
            return new Player(location.BoundTo(spaceSize), velocity, dir);
        }
    }
}
